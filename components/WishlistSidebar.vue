  ...
  <div id="wishlist">
    ...
    >
              ...
              >
               <template #configuration>
                  <div class="collected-product__properties">
                    <SfProperty v-for="(attribute, key) in wishlistGetters.getItemAttributes(product, ['size', 'color'])" :key="key" :name="key" :value="attribute"/>
                  </div>
                </template>
      ...
      <template #content-bottom>
        <SfButton @click="toggleWishlistSidebar" class="sf-button--full-width">
          {{ $t('Start shopping') }}
        </SfButton>
      </template>
    </SfSidebar>
